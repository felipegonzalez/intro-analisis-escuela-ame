...
reconoce que puede tener un problema de varianza. Decide usar regresión regularizada (ridge)
con tres valores: casi ninguna regularización, regularización moderada, y muy regularizado. Usaremos 
el paquete *glmnet* (@glmnet).
