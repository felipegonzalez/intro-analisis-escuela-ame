...
(ver por ejemplo @GelmanHill para un curso interesante). Los
...
de predicción para un modelo de bosques aleatorios (ver por ejemlo @rfintervals).
...
Ajustamos un bosque aleatorio y construimos intervalos predictivos usando el paquete [rfinterval](https://github.com/haozhestat/rfinterval):
