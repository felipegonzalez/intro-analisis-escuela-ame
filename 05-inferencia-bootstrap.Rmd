...
ggplot(aes(sample = precio_miles, colour = tipo, group = tipo)) + 
    geom_qq(distribution = stats::qunif, alpha = 0.7, size = 0.5) + 
...
la cobertura, pues es posible que nuestros intervalos no tengan "cobertura simétrica", por ejemplo.
Para muchos estimadores,
