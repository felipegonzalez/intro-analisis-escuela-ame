...
g_2 <- ggplot(resumen_boot, aes(x = grupo, y = mediana, ymin = ymin, ymax = ymax)) +
    ...
    labs(subtitle = "Intervalos de 95% \n para la mediana", caption = "Nótese escalas diferentes de graficas")
...
Esto comunica correctamente que tenemos incertidumbre alta acerca de nuestras
...
interesados en el tema. Esta gráfica informa esa decisión.
...
El bootstrap es una técnica para evaluar la variabilidad de estimaciones basadas en una muestra. La situación más simple donde podemos aplicar bootstrap es la siguiente:
