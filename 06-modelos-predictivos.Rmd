...
En esta parte discutiremos las ideas básicas de los modelación predictiva. Mucho de este material
proviene de nuestra referencia principal que es @ESL. 
...
Ponemos en rojo nuestra predición, y ahora repetimos para el rango de *frac*:
...
Y mostramos cómo serían las predicciones de este método para distintos valores de *frac*. 
...
**esta es una pregunta mucha más difíci** que la contesta una comparación predictiva. No se refiere a 
cómo son diferentes grupos de estados, si no a una misma unidad (estado) bajo distintas condiciones.
...
Esto es contraintuitivo en un principio. Podemos ver un ejemplo (@ESL):
...
La recta del ejemplo anterior es muy rígida para este problema.
