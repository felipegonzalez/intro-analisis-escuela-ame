...
Ahora contrastemos con otro ejemplo. En el siguiente caso obtenemos:
...
Podemos calcular la respuesta como :
...
superior e inferior de las dos distribuciones.
...
2 * min(dist_perm_nv(dif), 1- dist_perm_nv(dif))
```
