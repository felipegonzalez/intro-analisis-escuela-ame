...
$$f(x+ \Delta x) - f(x) \approx \frac{\Delta x }{x}$$
para cualquier $\Delta x$. Esto implica que la derivada de $f$ tiene que ser $1/x$,
y por lo tanto la transfomración que buscamos es el logaritmo. 

$$\log(a + \Delta) - \log(a) = log(1 + \Delta/a) \approx  \Delta/a,$$
la aproximación es muy buena si $\Delta/a$ es menor que 0.2 en valor absoluto. 
...
Y la variación es más similar a lo largo de cada zona. Los cuartiles superiores e inferiores
