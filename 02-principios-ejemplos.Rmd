...
que tardan distintas personas en fusionar un [estereograma](https://en.wikipedia.org/wiki/Autostereogram#/media/File:Stereogram_Tut_Random_Dot_Shark.png) para ver una imagen 3D.
...
hacemos final es causal : la descripción verbal reduce el tiempo de fusión a 2/3 en promedio comparado con no recibir la descripción verbal. Esto lo podemos hacer pues 
...
similares en promedio, las diferencias que puedan tener se debe al azar, y podemos
